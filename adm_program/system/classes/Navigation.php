...
class Navigation
{
     ...
     */
    public function addUrl($url, $text = null, $icon = null): bool
    {
        global $gLogger;
     ...
     */
    public function getHtmlBackButton($id = 'adm-navigation-back'): string
    {
        global $gL10n;
     ...
     */
    public function getHtmlNavigationBar($id = 'adm-navigation-bar'): string
    {
        $links = array();
