...
function admFuncGeneratePagination(string $baseUrl, int $itemsCount, int $itemsPerPage, int $pageStartItem, bool $addPrevNextText = true, string $queryParamName = 'start'): string
{
     ...
     * @return string
     */
    function getListElementString(string $linkText, string $className = '', string $url = '', string $paramName = '', int $paramValue = null): string
    {
        $classString = '';
        if ($className !== '')
        {
 ...
 */
function admFuncShowCreateChangeInfoById(int $userIdCreated, string $timestampCreate, int $userIdEdited = 0, string $timestampEdited = null): string
{
